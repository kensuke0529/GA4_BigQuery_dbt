...
/*
  Session Duration by Traffic Source & Device
  
  Groups sessions by traffic source, device, and duration cohort
  (excluding landing page for simpler analysis).
*/
...
from cohorts
group by traffic_source, device_category, duration_cohort, cohort_order
order by traffic_source, device_category, cohort_order
